...
const AdminNavbar = () => {
  ...
  <div className='flex flex-wrap items-center gap-5 w-full'>
      ...
      <ul
        ...
        <li className='max-lg:border-b max-lg:py-3 px-3'>
          <a href='javascript:void(0)'
            className='hover:text-[#007bff] text-[#007bff] font-semibold block text-[15px]'>Add Property</a>
        </li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
            className='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Bulk Upload Property</a>
        </li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
            className='hover:text-[#007bff] text-[#333] font-semibold block text-[15px]'>Enquiry Response</a>
        </li>
        <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
    ...
    <div className='flex items-center max-lg:ml-auto space-x-6'>
      <button
        className='px-4 py-2 text-[15px] rounded font-semibold text-[#007bff] border-2 border-[#007bff] hover:bg-[#007bff] transition-all ease-in-out duration-300 bg-transparent hover:text-white'>Sign
        up</button>
