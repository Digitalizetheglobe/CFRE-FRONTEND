...
function Blog1() {
    ...
    <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto p-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">1. Location and Connectivity</h2>
            <p className="text-base text-gray-800 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">2. Infrastructure and Development</h2>
            <p className="text-base text-gray-800 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">3. Commercial and Residential Balance</h2>
            <p className="text-base text-gray-800 mb-6">
      ...
      {isSubmitted && (
        ...
        >
          <div className="bg-white p-6 rounded-lg shadow-lg text-center relative z-50">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">7. Quality of Construction and Amenities</h2>
            <p className="text-lg text-gray-800 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">8. Legal and Regulatory Compliance</h2>
            <p className="text-lg text-gray-800 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">9. Environmental and Social Factors</h2>
            <p className="text-lg text-gray-800 mb-6">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">10. Expert Consultation</h2>
            <p className="text-lg text-gray-800 mb-6">
