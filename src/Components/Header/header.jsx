...
//         <header className='shadow-md tracking-wide relative z-50'>
//             <div>
//             <div className='flex flex-wrap items-center justify-between gap-5 w-full mt-5'>
//                 <Link to="/">
//                     <img
//                         src={logo}
//                         alt="logo"
//                         className="w-16 mx-10 mt-1 transition-transform duration-300 ease-in-out transform shadow-lg"
//                     />
//                 </Link>
//                 <div
//                     id="collapseMenu"
...
//                             )}
//                         </li>
//                         <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3 relative' ref={investDropdownRef}>
//                             <button
//                                 onClick={toggleInvestDropdown}
//                                 className='hover:text-[#d84a48] text-gray-800 block text-[18px] focus:outline-none'>
//                                 Invest
...
//                                 <ul className='absolute left-0 bg-white shadow-lg mt-2 rounded-md z-50 border border-gray-200 w-36 cursor-pointer'>
//                                     <li className='py-2 px-4 hover:bg-gray-200' onClick={handleInvestOptionClick}>
//                                         <Link to="/OfficeSpaces">Office Spaces</Link>
//                                     </li>
//                                     <li className='py-2 px-4 hover:bg-gray-200' onClick={handleInvestOptionClick}>
...
//                     </ul>
//                 </div>
//                 <button id="toggleOpen" className='lg:hidden block bg-gray-200 p-2 rounded-md'>
...
function Header() {
    ...
    return (
        <header className="shadow-md tracking-wide relative z-50">
            <div className="flex items-center justify-between w-full p-4 ml-2">
                {/* Logo in the corner */}
                ...
                <nav className="flex-grow">
                    <ul className="flex justify-center items-center gap-x-8 pr-8 max-lg:flex-col lg:flex-row">
                        ...
                        <li className="relative" ref={investDropdownRef}>
                            ...
                            {isInvestDropdownOpen && (
                                <ul className="absolute left-0 bg-white shadow-lg mt-2 rounded-md z-50 border border-gray-200 w-40 cursor-pointer">
                                    <li className="py-2 px-4 hover:bg-gray-200" onClick={handleInvestOptionClick}>
                                        <Link to="/OfficeSpaces">Office Spaces</Link>
                                    </li>
                                    <li className="py-2 px-4 hover:bg-gray-200" onClick={handleInvestOptionClick}>
            ...
            {/* Mobile Menu */}
            <div id="collapseMenu" className="lg:hidden hidden bg-white w-full fixed top-0 left-0 shadow-md">
                <button id="toggleClose" className="block bg-gray-200 p-2 rounded-md absolute top-4 right-4 z-50">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                <ul className="p-6 space-y-4">
                    ...
                    <li>
                        <button onClick={toggleRentDropdown} className="text-gray-800 text-lg">Rent</button>
                    </li>
                    <li>
                        <button onClick={toggleInvestDropdown} className="text-gray-800 text-lg">Invest</button>
                    </li>
                </ul>
            </div>
        </header>
