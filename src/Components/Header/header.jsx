                ...
                <div id="collapseMenu"
                    ...
                    <ul
                        ...
                        <li className='max-lg:border-b border-gray-300 max-lg:py-3 px-3 relative'>
                            ...
                            {isRentDropdownOpen && (
                                <ul className='absolute left-0 bg-white shadow-lg mt-2 rounded-md z-50 border border-gray-200 w-48'>
...
//                                     </li>
//                                     <li className='py-2 px-4 hover:bg-gray-200'>
//                                         <Link to='/un-furnished'>Un-Furnished</Link>
//                                     </li>
//                                     <li className='py-2 px-4 hover:bg-gray-200'>
...
//                                 <ul className='absolute left-0 bg-white shadow-lg mt-2 rounded-md z-50 border border-gray-200 w-36'>
//                                     <li className='py-2 px-4 hover:bg-gray-200'>
//                                         <Link to='/pre-leases'>Pre-Leases</Link>
//                                     </li>
//                                     <li className='py-2 px-4 hover:bg-gray-200'>
//                                         <Link to='/un-leased'>Un-Leased</Link>
//                                     </li>
//                                 </ul>
//                             )}
//                         </li>
