        ...
        <>
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-8xl mx-auto">
                ...
                <div className="border border-gray-300 rounded-lg shadow-sm bg-white p-4 max-w-8xl mx-auto mt-5 flex flex-wrap lg:flex-nowrap">
                    ...
                    {/* Right Section - Recent Properties */}
            ...
            <div key={index} className="flex items-center p-4 bg-gray-100 rounded-lg shadow-sm">
                ...
                <div>
                    <div className="text-lg font-bold text-gray-800">{property.carpetArea} sq.ft</div>
                    <div className="text-gray-600">Available in {property.location}</div>
                    <div className="text-gray-900 font-semibold mt-2">₹{property.rentPerMonth}</div>
                </div>
            </div>
        ))}
                        </div>
