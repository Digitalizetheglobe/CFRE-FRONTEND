...
//                 setFilteredProperties(response.data.filter(property =>
//                     property.furnishing.toLowerCase() === 'furnished' || 
//                     property.furnishing.toLowerCase() === 'fully furnished'
//                 ));
//             } catch (error) {
...
//                 <h1 className="text-4xl">Fully Furnished Properties</h1>
