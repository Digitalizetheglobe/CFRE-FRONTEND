...
//                             class="px-2 py-3 bg-white w-full text-gray-800 text-sm border-b border-gray-300 focus:border-[#d84a48] outline-none" />
...
//                             class="px-2 pt-3 bg-white w-full text-gray-800 text-sm border-b border-gray-300 focus:border-[#d84a48] outline-none"></textarea>
//                     </div>

//                     <button type="button"
//                         class="mt-8 flex items-center justify-center text-sm w-full rounded-md px-6 py-3 bg-[#d84a48] hover:bg-[#d84a48] text-white">
...
//                     <li class="flex items-center text-[#d84a48]">
...
//                             <strong>swapnil@cfrerealty.com</strong>
//                         </a>
//                     </li>
//                     <li class="flex items-center text-[#d84a48]">
//                         <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor'
...
//                     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3783.548551613884!2d73.85311307465182!3d18.50409726967826!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c01328410eb9%3A0x19ebdd52d7fa6ef6!2sHirabaug%20Business%20Center!5e0!3m2!1sen!2sin!4v1725004275510!5m2!1sen!2sin" 
//                     width="600" 
//                     height="450" 
...
function ContactUs() {
    ...
    return (
        <>
            ...
            <Blogslider />
            <div
                className="py-24 sm:py-16 bg-cover bg-center"
                style={{ backgroundImage: `url(${Image})` }}
            >
                <div className="mx-auto max-w-7xl px-6 lg:px-8 bg-opacity-75  rounded-lg p-8">
                    <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-4">
                        ...
                        <div className="mx-auto flex max-w-xs flex-col gap-y-4">
                            <dt className="text-2xl leading-7 text-gray-900">Sq.Ft</dt>
                            <dd className="order-first text-3xl font-semibold tracking-tight text-gray-900 sm:text-5xl">2.5 MN</dd>
                        </div>
                        <div className="mx-auto flex max-w-xs flex-col gap-y-4">
