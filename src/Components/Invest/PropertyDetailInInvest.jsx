...
const PropertyDetailInRent = () => {
    ...
    useEffect(() => {
        const fetchProperty = async () => {
            try {
                const response = await axios.get(`http://192.168.0.105:8000/saleproperty/${id}`);
            ...
            <div className="max-w-8xl mx-auto">
                        ...
                        <div className="flex-1 w-full lg:w-2/5 mt-11">
                            <div className="bg-white border border-gray-500 shadow-md shadow-slate-700 rounded-lg overflow-hidden p-4">
                                ...
                                <div className="flex flex-col mb-4">
                                    <h3 className="text-2xl font-bold">₹{property.basicPrice}</h3>
                                ...
                                <div className="flex justify-between mb-4">
                                    <div className="p-2 border border-gray-500 rounded-md text-right">
                                        ...
                                        <p className="text-lg font-semibold">{property.yield}12%</p>
                                    </div>
                                    <div className="p-2 border border-gray-500 rounded-md text-right">
                                        <p className="text-gray-500 text-xs">Monthly Rental:</p>
                                        <p className="text-lg font-semibold">₹{property.rental}3.4 L</p>
                                    </div>
                                </div>
                ...
                <div className="w-full bg-white border border-gray-500 shadow-md rounded-lg overflow-hidden p-6 ">
                    ...
                    <div className="mb-20">
                        ...
                        <p className="text-gray-700">{property.aboutProperty}</p>
                    </div>
                    ...
                    <div className="mb-20">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <div className="flex-1 min-w-[150px] p-2 border border-gray-400 rounded-md">
                                <p className="text-gray-500 text-xs font-semibold">Configuration</p>
                                <p className="text-lg font-medium">{property.anyOtherFurniture}</p>
                            </div>
                            <div className="flex-1 min-w-[150px] p-2 border border-gray-400 rounded-md">
                                <p className="text-gray-500 text-xs font-semibold">Floor:</p>
                                <p className="text-lg font-medium">{property.floor}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-20">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <div className="flex-1 min-w-[150px] p-2 border border-gray-400 rounded-md">
                                ...
                                <p className="text-lg font-medium">{property.reserved2WheelerParking}</p>
                            </div>
                            <div className="flex-1 min-w-[150px] p-2 border border-gray-400 rounded-md">
                                <p className="text-gray-500 text-xs font-semibold">Car Parking
                                    :</p>
                                <p className="text-lg font-medium">{property.reservedCarParking
                                }</p>
                            </div>
                            <div className="flex-1 min-w-[150px] p-2 border border-gray-400 rounded-md">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            {property.amenities.split(',').map((amenity, index) => (
                                ...
                                >
                                    ...
                                    <p className="text-gray-700">{amenity.trim()}</p>
                                </div>
                            ))}
                        </div>
                    </div>
