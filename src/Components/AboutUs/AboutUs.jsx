                ...
                <div class="lg:max-w-6xl max-w-xl mx-auto p-4">
                    ...
                    <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 max-md:justify-center mt-12">
                        ...
                        <div class="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                            <img src="https://readymadeui.com/team-1.webp" alt="Company Logo" class="w-full sm:h-60 object-cover" />
                        ...
                        <div class="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                            <img src="https://readymadeui.com/team-3.webp" alt="Company Logo" class="w-full sm:h-60 object-cover" />
                        ...
                        <div class="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                            <img src="https://readymadeui.com/team-4.webp" alt="Company Logo" class="w-full sm:h-60 object-cover" />
                        ...
                        <div class="flex items-center max-sm:flex-col bg-gray-100 gap-4 rounded-lg overflow-hidden hover:scale-[1.02] transition-all">
                            <img src="https://readymadeui.com/team-5.webp" alt="Company Logo" class="w-full sm:h-60 object-cover" />
